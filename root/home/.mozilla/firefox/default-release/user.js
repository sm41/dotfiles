...
user_pref("font.name.sans-serif.ja",          "Roboto Flex,  Nimbus Sans L,  Liberation Sans,  IPA Pゴシック");   // ゴシック   (ひげ飾り 無し)
user_pref("font.name.sans-serif.x-western",   "Roboto Flex,  Nimbus Sans L,  Liberation Sans,  IPA Pゴシック");   // サンセリフ (ひげ飾り 無し)
