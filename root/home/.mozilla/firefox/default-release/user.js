...
user_pref("browser.tabs.hoverPreview.enabled",false);         // マウスカーソルをタブ上に置いた場合のプレビュー
user_pref("browser.tabs.hoverPreview.showThumbnails",false);  // マウスカーソルをタブ上に置いた場合のサムネイル
...
user_pref("font.name.monospace.ja",           "Liberation Mono,  Roboto Mono,  Takaoゴシック");     // 等幅
user_pref("font.name.monospace.x-western",    "Liberation Mono,  Roboto Mono,  Takaoゴシック");     // 等幅
user_pref("font.name.sans-serif.ja",          "Roboto Flex,  Liberation Sans,  Takao Pゴシック");   // ゴシック   (ひげ飾り 無し)
user_pref("font.name.sans-serif.x-western",   "Roboto Flex,  Liberation Sans,  Takao Pゴシック");   // サンセリフ (ひげ飾り 無し)
user_pref("font.name.serif.ja",               "Roboto serif, Liberation Serif, Takao P明朝");    // 明朝体 (ひげ飾り 有り)
user_pref("font.name.serif.x-western",        "Roboto serif, Liberation Serif, Takao P明朝");    // セリフ (ひげ飾り 有り)
...
user_pref("layout.css.prefers-color-scheme.content-override",0);   // オプション  ->  一般  ->  言語と外観  ->  ウェブサイトの外観
...
user_pref("ui.context_menus.after_mouseup",true);                    // ボタンを離すまでコンテキストメニューを抑止する
